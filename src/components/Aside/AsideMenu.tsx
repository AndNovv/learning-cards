...
const AsideMenu = () => {
    ...
    return (
        <motion.aside
            ...
            className={cn("md:relative md:translate-x-0 -translate-x-[300px] absolute bg-background z-10 flex flex-col shrink-0 w-[300px] items-center h-screen p-4 border-r")}
        >
